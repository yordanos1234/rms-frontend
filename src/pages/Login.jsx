...
const Login = () => {
  ...
  return (
    <Box sx={{
      ...
      background: 'linear-gradient(135deg, #f0f4f8 0%, #e2e8f0 100%)', py: 4,
    }}>
      <Container maxWidth="xs">
        <Fade in timeout={600}>
          <Paper elevation={0} sx={{
            p: { xs: 3, sm: 5 }, borderRadius: 4, boxShadow: '0 12px 48px rgba(0,0,0,0.08)',
            ...
            <Box sx={{ mt: 4, p: 2.5, bgcolor: '#f8fafc', borderRadius: 3, border: '1px dashed rgba(15,76,129,0.15)' }}>
              <Typography variant="caption" display="block" sx={{ color: '#5a6a7a', fontWeight: 600, mb: 1 }}>Demo Accounts</Typography>
              {[
                ['admin@rms.com', 'Admin'],
